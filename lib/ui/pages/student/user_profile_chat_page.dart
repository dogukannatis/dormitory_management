...
class _UserProfileChatsState extends State<UserProfileChats> {
  ...
  List<Message> messages = [
    Message(
        ...
        receiverID: '2',
        content: 'Hello',
        createdAt: DateTime.now().subtract(const Duration(minutes: 500))),
    Message(
        id: '2',
        senderID: '2',
        receiverID: '1',
        content: 'Hi! How are you?',
        createdAt: DateTime.now().subtract(const Duration(minutes: 350))),
    Message(
        id: '3',
        senderID: '1',
        receiverID: '2',
        content: 'I\'m good, thanks! How about you?',
        createdAt: DateTime.now().subtract(const Duration(minutes: 250))),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        ...
        children: [
          const CustomDrawer(activePage: ActivePages.profileChats,),
